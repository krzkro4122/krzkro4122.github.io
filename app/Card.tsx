...
export const Card = (card: CardProps) => {
  return (
    <Link
      href={card.href}
      target="_blank"
      className="rounded-2xl bg-black lg:h-52 lg:aspect-[1.6/1] flex flex-col min-w-max overflow-hidden justify-between border-4 border-black border- hover:underline hover:scale-105 active:opacity-95 cursor-pointer"
    >
